...
from user.forms import LoginForm, RegisterForm, ChangeNicknameForm, BindEmailForm, ChangePasswordForm, \
    ForgetPasswordForm
...
def login(request):
    if request.method == "POST":
        ...
        if login_form.is_valid():
            ...
            return redirect(request.GET.get('from', reverse('home')).split('?from=')[-1])
    else:
